<template>
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <div class="flex-grow container mx-auto px-4 py-12">
      <h1 class="text-3xl font-bold text-gray-900 mb-6">All Smartphones</h1>
                ...
                <div class="p-5">
                  ...
                  <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center text-yellow-400">
                      <svg v-for="i in 5" :key="i" class="w-5 h-5" :class="{ 'text-gray-300': i > 4 }"
                  ...
                  <div class="flex space-x-2">
                    ...
                    <button @click="addToCart(product)"
                      class="btn-primary py-2 px-4 rounded-lg font-medium transition-colors duration-300">
      ...
      <p v-else class="text-gray-600">No smartphones available at the moment.</p>
    </div>
